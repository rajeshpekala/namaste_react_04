...
const Header = () => {
    return (
        <div className = "header">
            ...
            <img className = "logo" src ="https://st2.depositphotos.com/1007566/7919/v/450/depositphotos_79190100-stock-illustration-delicious-sushi-design.jpg" alt = "logo" />
            </div>
...
const Restaurant = (props) => {
    ...
    return(
        <div className ="res_card">
            ...
            <div>
                <img className = "res_img" src ={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+ 
             cloudinaryImageId
                }/>
            </div >
            <div  className ="he">
...
},
{
  "info": {
    ...
    "availability": {
      "nextCloseTime": "2023-11-07 05:55:00",
      "opened": true
    },
    "badges": {
      "imageBadges": [
...
},
{
  "info": {
    ...
    "availability": {
      "nextCloseTime": "2023-11-07 03:15:00",
      "opened": true
    },
    "badges": {
      "textExtendedBadges": [
...
},
{
  "info": {
    ...
    "availability": {
      "nextCloseTime": "2023-11-07 00:59:00",
      "opened": true
    },
    "badges": {
...
},
{
  "info": {
    ...
    "cloudinaryImageId": "pnmnh0seraufqb5esj7y",
    "locality": "BTM Layout",
    "areaName": "BTM Layout",
    "costForTwo": "₹250 for two",
    "cuisines": [
...
},
{
  ...
  "cta": {
    "link": "https://www.swiggy.com/restaurants/keventers-milkshakes-and-desserts-7th-block-koramangala-bangalore-63381",
    "type": "WEBLINK"
  }
},
{
    ...
    return(
        <div className = "appbody">
            <div className = "sear">
                ...
                <button className = "butter" type = "button" >FindFood</button>
            </div >
